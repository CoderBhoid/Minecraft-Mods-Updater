      ...
      <div className="flex-1 flex items-center justify-center w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full text-left">
          <div className="space-y-4 p-6 rounded-2xl bg-zinc-900/20 border border-zinc-800/50 hover:border-[#1bd96a]/30 transition-colors group">
            ...
            <h3 className="text-xl text-white font-semibold group-hover:text-[#1bd96a] transition-colors">Smart Detection</h3>
          ...
          <div className="space-y-4 p-6 rounded-2xl bg-zinc-900/20 border border-zinc-800/50 hover:border-[#1bd96a]/30 transition-colors group">
             ...
             <h3 className="text-xl text-white font-semibold group-hover:text-[#1bd96a] transition-colors">Dependency Resolver</h3>
             <p className="text-zinc-500 leading-relaxed text-sm">
          ...
          <div className="space-y-4 p-6 rounded-2xl bg-zinc-900/20 border border-zinc-800/50 hover:border-[#1bd96a]/30 transition-colors group md:col-span-2 lg:col-span-1">
             ...
             <h3 className="text-xl text-white font-semibold group-hover:text-[#1bd96a] transition-colors">Bulk Updates</h3>
             <p className="text-zinc-500 leading-relaxed text-sm">
